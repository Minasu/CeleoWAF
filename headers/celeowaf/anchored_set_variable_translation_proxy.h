...
#ifndef HEADERS_CELEOWAF_ANCHORED_SET_VARIABLE_TRANSLATION_PROXY_H_
#define HEADERS_CELEOWAF_ANCHORED_SET_VARIABLE_TRANSLATION_PROXY_H_
...
#endif  // HEADERS_CELEOWAF_ANCHORED_SET_VARIABLE_TRANSLATION_PROXY_H_
