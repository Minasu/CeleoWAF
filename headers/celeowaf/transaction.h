...
#ifndef HEADERS_CELEOWAF_TRANSACTION_H_
#define HEADERS_CELEOWAF_TRANSACTION_H_
...
#include "celeowaf/anchored_variable.h"
...
#include "celeowaf/variable_origin.h"
#include "celeowaf/anchored_set_variable_translation_proxy.h"
...
class Transaction : public TransactionAnchoredVariables, public TransactionSecMarkerManagement {
 public:
    Transaction(CeleoWAF *transaction, RulesSet *rules, void *logCbData);
    Transaction(CeleoWAF *transaction, RulesSet *rules, char *id,
        void *logCbData);
    ~Transaction();
    ...
    /**
     * Types of request body that CeleoWAF may give a special treatment
     * for the data.
     */
    ...
    bool intervention(CeleoWAFIntervention *it);
    ...
    /**
     * CeleoWAF instance used to start this transaction. Basically used
     ...
     * auditlogs.
     */
    std::list<celeowaf::RuleMessage> m_rulesMessages;
     ...
     */
    celeowaf::actions::disruptive::AllowType m_allowType;
     ...
     * that transaction.
     */
    std::vector<CeleoWAFIntervention> m_actions;
    CeleoWAFIntervention m_it;
...
Transaction *msc_new_transaction(CeleoWAF *ms,
    RulesSet *rules, void *logCbData);

/** @ingroup CeleoWAF_C_API */
Transaction *msc_new_transaction_with_id(CeleoWAF *ms,
...
/** @ingroup CeleoWAF_C_API */
int msc_intervention(Transaction *transaction, CeleoWAFIntervention *it);
...
#endif  // HEADERS_CELEOWAF_TRANSACTION_H_
