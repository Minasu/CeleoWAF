...
#ifndef HEADERS_CELEOWAF_AUDIT_LOG_H_
#define HEADERS_CELEOWAF_AUDIT_LOG_H_
...
class AuditLog {
 public:
    ...
    enum AuditLogParts {
     ...
     /**
      * Request body (present only if the request body exists and CeleoWAF
     ...
     /**
      * Intermediary response body (present only if CeleoWAF is configured
      ...
      * actual response body unless CeleoWAF intercepts the intermediary
...
#endif  // HEADERS_CELEOWAF_AUDIT_LOG_H_
