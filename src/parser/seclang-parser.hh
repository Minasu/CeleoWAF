...
namespace yy {
#line 429 "seclang-parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_VARIABLE_MULTIPART_PART_HEADERS = 281,
        TOK_VARIABLE_ARGS_COMBINED_SIZE = 282,
        TOK_VARIABLE_ARGS_GET_NAMES = 283,
        TOK_VARIABLE_RULE = 284,
        TOK_VARIABLE_ARGS_NAMES = 285,
        TOK_VARIABLE_ARGS_POST_NAMES = 286,
        TOK_VARIABLE_AUTH_TYPE = 287,
        TOK_VARIABLE_FILES_COMBINED_SIZE = 288,
        TOK_VARIABLE_FILES_TMP_NAMES = 289,
        TOK_VARIABLE_FULL_REQUEST = 290,
        TOK_VARIABLE_FULL_REQUEST_LENGTH = 291,
        TOK_VARIABLE_INBOUND_DATA_ERROR = 292,
        TOK_VARIABLE_MATCHED_VAR = 293,
        TOK_VARIABLE_MATCHED_VAR_NAME = 294,
        TOK_VARIABLE_MULTIPART_BOUNDARY_QUOTED = 295,
        TOK_VARIABLE_MULTIPART_BOUNDARY_WHITESPACE = 296,
        TOK_VARIABLE_MULTIPART_CRLF_LF_LINES = 297,
        TOK_VARIABLE_MULTIPART_DATA_AFTER = 298,
        TOK_VARIABLE_MULTIPART_DATA_BEFORE = 299,
        TOK_VARIABLE_MULTIPART_FILE_LIMIT_EXCEEDED = 300,
        TOK_VARIABLE_MULTIPART_HEADER_FOLDING = 301,
        TOK_VARIABLE_MULTIPART_INVALID_HEADER_FOLDING = 302,
        TOK_VARIABLE_MULTIPART_INVALID_PART = 303,
        TOK_VARIABLE_MULTIPART_INVALID_QUOTING = 304,
        TOK_VARIABLE_MULTIPART_LF_LINE = 305,
        TOK_VARIABLE_MULTIPART_MISSING_SEMICOLON = 306,
        TOK_VARIABLE_MULTIPART_SEMICOLON_MISSING = 307,
        TOK_VARIABLE_MULTIPART_STRICT_ERROR = 308,
        TOK_VARIABLE_MULTIPART_UNMATCHED_BOUNDARY = 309,
        TOK_VARIABLE_OUTBOUND_DATA_ERROR = 310,
        TOK_VARIABLE_PATH_INFO = 311,
        TOK_VARIABLE_QUERY_STRING = 312,
        TOK_VARIABLE_REMOTE_ADDR = 313,
        TOK_VARIABLE_REMOTE_HOST = 314,
        TOK_VARIABLE_REMOTE_PORT = 315,
        TOK_VARIABLE_REQBODY_ERROR_MSG = 316,
        TOK_VARIABLE_REQBODY_ERROR = 317,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR_MSG = 318,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR = 319,
        TOK_VARIABLE_REQBODY_PROCESSOR = 320,
        TOK_VARIABLE_REQUEST_BASENAME = 321,
        TOK_VARIABLE_REQUEST_BODY_LENGTH = 322,
        TOK_VARIABLE_REQUEST_BODY = 323,
        TOK_VARIABLE_REQUEST_FILE_NAME = 324,
        TOK_VARIABLE_REQUEST_HEADERS_NAMES = 325,
        TOK_VARIABLE_REQUEST_LINE = 326,
        TOK_VARIABLE_REQUEST_METHOD = 327,
        TOK_VARIABLE_REQUEST_PROTOCOL = 328,
        TOK_VARIABLE_REQUEST_URI_RAW = 329,
        TOK_VARIABLE_REQUEST_URI = 330,
        TOK_VARIABLE_RESOURCE = 331,
        TOK_VARIABLE_RESPONSE_BODY = 332,
        TOK_VARIABLE_RESPONSE_CONTENT_LENGTH = 333,
        TOK_VARIABLE_RESPONSE_CONTENT_TYPE = 334,
        TOK_VARIABLE_RESPONSE_HEADERS_NAMES = 335,
        TOK_VARIABLE_RESPONSE_PROTOCOL = 336,
        TOK_VARIABLE_RESPONSE_STATUS = 337,
        TOK_VARIABLE_SERVER_ADDR = 338,
        TOK_VARIABLE_SERVER_NAME = 339,
        TOK_VARIABLE_SERVER_PORT = 340,
        TOK_VARIABLE_SESSION_ID = 341,
        TOK_VARIABLE_UNIQUE_ID = 342,
        TOK_VARIABLE_URL_ENCODED_ERROR = 343,
        TOK_VARIABLE_USER_ID = 344,
        TOK_VARIABLE_WEB_APP_ID = 345,
        TOK_VARIABLE_STATUS = 346,
        TOK_VARIABLE_STATUS_LINE = 347,
        TOK_VARIABLE_IP = 348,
        TOK_VARIABLE_GLOBAL = 349,
        TOK_VARIABLE_TX = 350,
        TOK_VARIABLE_SESSION = 351,
        TOK_VARIABLE_USER = 352,
        TOK_VARIABLE_REQLIMIT = 353,
        TOK_RUN_TIME_VAR_ENV = 354,
        TOK_RUN_TIME_VAR_XML = 355,
        TOK_ACTION_SETVAR = 356,
        TOK_SETVAR_OPERATION_EQUALS = 357,
        TOK_SETVAR_OPERATION_EQUALS_PLUS = 358,
        TOK_SETVAR_OPERATION_EQUALS_MINUS = 359,
        TOK_NOT = 360,
        TOK_OPERATOR_BEGINS_WITH = 361,
        TOK_OPERATOR_CONTAINS = 362,
        TOK_OPERATOR_CONTAINS_WORD = 363,
        TOK_OPERATOR_DETECT_SQLI = 364,
        TOK_OPERATOR_DETECT_XSS = 365,
        TOK_OPERATOR_ENDS_WITH = 366,
        TOK_OPERATOR_EQ = 367,
        TOK_OPERATOR_FUZZY_HASH = 368,
        TOK_OPERATOR_GEOLOOKUP = 369,
        TOK_OPERATOR_GE = 370,
        TOK_OPERATOR_GSB_LOOKUP = 371,
        TOK_OPERATOR_GT = 372,
        TOK_OPERATOR_INSPECT_FILE = 373,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 374,
        TOK_OPERATOR_IP_MATCH = 375,
        TOK_OPERATOR_LE = 376,
        TOK_OPERATOR_LT = 377,
        TOK_OPERATOR_PM_FROM_FILE = 378,
        TOK_OPERATOR_PM = 379,
        TOK_OPERATOR_RBL = 380,
        TOK_OPERATOR_RSUB = 381,
        TOK_OPERATOR_RX_CONTENT_ONLY = 382,
        TOK_OPERATOR_RX = 383,
        TOK_OPERATOR_RX_GLOBAL = 384,
        TOK_OPERATOR_STR_EQ = 385,
        TOK_OPERATOR_STR_MATCH = 386,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 387,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 388,
        TOK_OPERATOR_VALIDATE_DTD = 389,
        TOK_OPERATOR_VALIDATE_HASH = 390,
        TOK_OPERATOR_VALIDATE_SCHEMA = 391,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 392,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 393,
        TOK_OPERATOR_VERIFY_CC = 394,
        TOK_OPERATOR_VERIFY_CPF = 395,
        TOK_OPERATOR_VERIFY_SSN = 396,
        TOK_OPERATOR_VERIFY_SVNR = 397,
        TOK_OPERATOR_WITHIN = 398,
        TOK_CONFIG_DIR_AUDIT_LOG_FMT = 399,
        TOK_JSON = 400,
        TOK_NATIVE = 401,
        TOK_ACTION_CTL_RULE_ENGINE = 402,
        TOK_ACTION_ACCURACY = 403,
        TOK_ACTION_ALLOW = 404,
        TOK_ACTION_APPEND = 405,
        TOK_ACTION_AUDIT_LOG = 406,
        TOK_ACTION_BLOCK = 407,
        TOK_ACTION_CAPTURE = 408,
        TOK_ACTION_CHAIN = 409,
        TOK_ACTION_CTL_AUDIT_ENGINE = 410,
        TOK_ACTION_CTL_AUDIT_LOG_PARTS = 411,
        TOK_ACTION_CTL_BDY_JSON = 412,
        TOK_ACTION_CTL_BDY_XML = 413,
        TOK_ACTION_CTL_BDY_URLENCODED = 414,
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 415,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 416,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 417,
        TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 418,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 419,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 420,
        TOK_ACTION_DENY = 421,
        TOK_ACTION_DEPRECATE_VAR = 422,
        TOK_ACTION_DROP = 423,
        TOK_ACTION_EXEC = 424,
        TOK_ACTION_EXPIRE_VAR = 425,
        TOK_ACTION_ID = 426,
        TOK_ACTION_INITCOL = 427,
        TOK_ACTION_LOG = 428,
        TOK_ACTION_LOG_DATA = 429,
        TOK_ACTION_MATURITY = 430,
        TOK_ACTION_MSG = 431,
        TOK_ACTION_MULTI_MATCH = 432,
        TOK_ACTION_NO_AUDIT_LOG = 433,
        TOK_ACTION_NO_LOG = 434,
        TOK_ACTION_PASS = 435,
        TOK_ACTION_PAUSE = 436,
        TOK_ACTION_PHASE = 437,
        TOK_ACTION_PREPEND = 438,
        TOK_ACTION_PROXY = 439,
        TOK_ACTION_REDIRECT = 440,
        TOK_ACTION_REV = 441,
        TOK_ACTION_SANITISE_ARG = 442,
        TOK_ACTION_SANITISE_MATCHED = 443,
        TOK_ACTION_SANITISE_MATCHED_BYTES = 444,
        TOK_ACTION_SANITISE_REQUEST_HEADER = 445,
        TOK_ACTION_SANITISE_RESPONSE_HEADER = 446,
        TOK_ACTION_SETENV = 447,
        TOK_ACTION_SETRSC = 448,
        TOK_ACTION_SETSID = 449,
        TOK_ACTION_SETUID = 450,
        TOK_ACTION_SEVERITY = 451,
        TOK_ACTION_SKIP = 452,
        TOK_ACTION_SKIP_AFTER = 453,
        TOK_ACTION_STATUS = 454,
        TOK_ACTION_TAG = 455,
        TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 456,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 457,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 458,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 459,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 460,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 461,
        TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 462,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 463,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 464,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 465,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 466,
        TOK_ACTION_TRANSFORMATION_LENGTH = 467,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 468,
        TOK_ACTION_TRANSFORMATION_MD5 = 469,
        TOK_ACTION_TRANSFORMATION_NONE = 470,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 471,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 472,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 473,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 474,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 475,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 476,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 477,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 478,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 479,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 480,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 481,
        TOK_ACTION_TRANSFORMATION_SHA1 = 482,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 483,
        TOK_ACTION_TRANSFORMATION_TRIM = 484,
        TOK_ACTION_TRANSFORMATION_TRIM_LEFT = 485,
        TOK_ACTION_TRANSFORMATION_TRIM_RIGHT = 486,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 487,
        TOK_ACTION_TRANSFORMATION_URL_ENCODE = 488,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 489,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 490,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 491,
        TOK_ACTION_VER = 492,
        TOK_ACTION_XMLNS = 493,
        TOK_CONFIG_COMPONENT_SIG = 494,
        TOK_CONFIG_CONN_ENGINE = 495,
        TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 496,
        TOK_CONFIG_SEC_WEB_APP_ID = 497,
        TOK_CONFIG_SEC_SERVER_SIG = 498,
        TOK_CONFIG_DIR_AUDIT_DIR = 499,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 500,
        TOK_CONFIG_DIR_AUDIT_ENG = 501,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 502,
        TOK_CONFIG_DIR_AUDIT_LOG = 503,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 504,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 505,
        TOK_CONFIG_DIR_AUDIT_STS = 506,
        TOK_CONFIG_DIR_AUDIT_TPE = 507,
        TOK_CONFIG_DIR_DEBUG_LOG = 508,
        TOK_CONFIG_DIR_DEBUG_LVL = 509,
        TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 510,
        TOK_CONFIG_SEC_DISABLE_BACKEND_COMPRESS = 511,
        TOK_CONFIG_SEC_HASH_ENGINE = 512,
        TOK_CONFIG_SEC_HASH_KEY = 513,
        TOK_CONFIG_SEC_HASH_PARAM = 514,
        TOK_CONFIG_SEC_HASH_METHOD_RX = 515,
        TOK_CONFIG_SEC_HASH_METHOD_PM = 516,
        TOK_CONFIG_SEC_CHROOT_DIR = 517,
        TOK_CONFIG_DIR_GEO_DB = 518,
        TOK_CONFIG_DIR_GSB_DB = 519,
        TOK_CONFIG_SEC_GUARDIAN_LOG = 520,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 521,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 522,
        TOK_CONFIG_SEC_CONN_R_STATE_LIMIT = 523,
        TOK_CONFIG_SEC_CONN_W_STATE_LIMIT = 524,
        TOK_CONFIG_SEC_SENSOR_ID = 525,
        TOK_CONFIG_DIR_ARGS_LIMIT = 526,
        TOK_CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT = 527,
        TOK_CONFIG_DIR_REQ_BODY = 528,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 529,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 530,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 531,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 532,
        TOK_CONFIG_DIR_RES_BODY = 533,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 534,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 535,
        TOK_CONFIG_SEC_RULE_INHERITANCE = 536,
        TOK_CONFIG_SEC_RULE_PERF_TIME = 537,
        TOK_CONFIG_DIR_RULE_ENG = 538,
        TOK_CONFIG_DIR_SEC_ACTION = 539,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 540,
        TOK_CONFIG_DIR_SEC_MARKER = 541,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 542,
        TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 543,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 544,
        TOK_CONFIG_SEC_HTTP_BLKEY = 545,
        TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 546,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 547,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 548,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 549,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 550,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 551,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 552,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 553,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 554,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 555,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 556,
        TOK_CONFIG_UPLOAD_DIR = 557,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 558,
        TOK_CONFIG_UPLOAD_FILE_MODE = 559,
        TOK_CONFIG_VALUE_ABORT = 560,
        TOK_CONFIG_VALUE_DETC = 561,
        TOK_CONFIG_VALUE_HTTPS = 562,
        TOK_CONFIG_VALUE_AMQP = 563,
        TOK_CONFIG_VALUE_OFF = 564,
        TOK_CONFIG_VALUE_ON = 565,
        TOK_CONFIG_VALUE_PARALLEL = 566,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 567,
        TOK_CONFIG_VALUE_REJECT = 568,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 569,
        TOK_CONFIG_VALUE_SERIAL = 570,
        TOK_CONFIG_VALUE_WARN = 571,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 572,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 573,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 574,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 575,
        TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 576,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 577,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 578,
        TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 579,
        TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 580,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 581,
        TOK_DIRECTIVE = 582,
        TOK_DIRECTIVE_SECRULESCRIPT = 583,
        TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 584,
        TOK_QUOTATION_MARK = 585,
        TOK_RUN_TIME_VAR_BLD = 586,
        TOK_RUN_TIME_VAR_DUR = 587,
        TOK_RUN_TIME_VAR_HSV = 588,
        TOK_RUN_TIME_VAR_REMOTE_USER = 589,
        TOK_RUN_TIME_VAR_TIME = 590,
        TOK_RUN_TIME_VAR_TIME_DAY = 591,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 592,
        TOK_RUN_TIME_VAR_TIME_HOUR = 593,
        TOK_RUN_TIME_VAR_TIME_MIN = 594,
        TOK_RUN_TIME_VAR_TIME_MON = 595,
        TOK_RUN_TIME_VAR_TIME_SEC = 596,
        TOK_RUN_TIME_VAR_TIME_WDAY = 597,
        TOK_RUN_TIME_VAR_TIME_YEAR = 598,
        TOK_VARIABLE = 599,
        TOK_DICT_ELEMENT = 600,
        TOK_DICT_ELEMENT_REGEXP = 601
      };
    };
  ...
  basic_symbol (typename Base::kind_type t, const std::unique_ptr<std::vector<std::unique_ptr<actions::Action> > >  v, const location_type& l);
    ...
    static inline
    symbol_type
    make_VARIABLE_REQLIMIT (const location_type& l);
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 3735,     ///< Last index in yytable_.
  ...
  seclang_parser::yytranslate_ (token_type t)
  {
    ...
    const unsigned int user_token_number_max_ = 601;
  ...
  seclang_parser::symbol_type
  seclang_parser::make_VARIABLE_MULTIPART_PART_HEADERS (const location_type& l)
  {
  ...
  seclang_parser::symbol_type
  seclang_parser::make_VARIABLE_REQLIMIT (const location_type& l)
  {
    return symbol_type (token::TOK_VARIABLE_REQLIMIT, l);
  }
  ...
  seclang_parser::symbol_type
  seclang_parser::make_OPERATOR_RX_GLOBAL (const location_type& l)
  {
  ...
  seclang_parser::symbol_type
  seclang_parser::make_CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT (const std::string& v, const location_type& l)
  {
...
#line 6227 "seclang-parser.hh" // lalr1.cc:377
