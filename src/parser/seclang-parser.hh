...
#line 351 "seclang-parser.hh" // lalr1.cc:377
...
namespace yy {
#line 428 "seclang-parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_RUN_TIME_VAR_ENV = 353,
        TOK_RUN_TIME_VAR_XML = 354,
        TOK_ACTION_SETVAR = 355,
        TOK_SETVAR_OPERATION_EQUALS = 356,
        TOK_SETVAR_OPERATION_EQUALS_PLUS = 357,
        TOK_SETVAR_OPERATION_EQUALS_MINUS = 358,
        TOK_NOT = 359,
        TOK_OPERATOR_BEGINS_WITH = 360,
        TOK_OPERATOR_CONTAINS = 361,
        TOK_OPERATOR_CONTAINS_WORD = 362,
        TOK_OPERATOR_DETECT_SQLI = 363,
        TOK_OPERATOR_DETECT_XSS = 364,
        TOK_OPERATOR_ENDS_WITH = 365,
        TOK_OPERATOR_EQ = 366,
        TOK_OPERATOR_FUZZY_HASH = 367,
        TOK_OPERATOR_GEOLOOKUP = 368,
        TOK_OPERATOR_GE = 369,
        TOK_OPERATOR_GSB_LOOKUP = 370,
        TOK_OPERATOR_GT = 371,
        TOK_OPERATOR_INSPECT_FILE = 372,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 373,
        TOK_OPERATOR_IP_MATCH = 374,
        TOK_OPERATOR_LE = 375,
        TOK_OPERATOR_LT = 376,
        TOK_OPERATOR_PM_FROM_FILE = 377,
        TOK_OPERATOR_PM = 378,
        TOK_OPERATOR_RBL = 379,
        TOK_OPERATOR_RSUB = 380,
        TOK_OPERATOR_RX_CONTENT_ONLY = 381,
        TOK_OPERATOR_RX = 382,
        TOK_OPERATOR_RX_GLOBAL = 383,
        TOK_OPERATOR_STR_EQ = 384,
        TOK_OPERATOR_STR_MATCH = 385,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 386,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 387,
        TOK_OPERATOR_VALIDATE_DTD = 388,
        TOK_OPERATOR_VALIDATE_HASH = 389,
        TOK_OPERATOR_VALIDATE_SCHEMA = 390,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 391,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 392,
        TOK_OPERATOR_VERIFY_CC = 393,
        TOK_OPERATOR_VERIFY_CPF = 394,
        TOK_OPERATOR_VERIFY_SSN = 395,
        TOK_OPERATOR_VERIFY_SVNR = 396,
        TOK_OPERATOR_WITHIN = 397,
        TOK_CONFIG_DIR_AUDIT_LOG_FMT = 398,
        TOK_JSON = 399,
        TOK_NATIVE = 400,
        TOK_ACTION_CTL_RULE_ENGINE = 401,
        TOK_ACTION_ACCURACY = 402,
        TOK_ACTION_ALLOW = 403,
        TOK_ACTION_APPEND = 404,
        TOK_ACTION_AUDIT_LOG = 405,
        TOK_ACTION_BLOCK = 406,
        TOK_ACTION_CAPTURE = 407,
        TOK_ACTION_CHAIN = 408,
        TOK_ACTION_CTL_AUDIT_ENGINE = 409,
        TOK_ACTION_CTL_AUDIT_LOG_PARTS = 410,
        TOK_ACTION_CTL_BDY_JSON = 411,
        TOK_ACTION_CTL_BDY_XML = 412,
        TOK_ACTION_CTL_BDY_URLENCODED = 413,
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 414,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 415,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 416,
        TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 417,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 418,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 419,
        TOK_ACTION_DENY = 420,
        TOK_ACTION_DEPRECATE_VAR = 421,
        TOK_ACTION_DROP = 422,
        TOK_ACTION_EXEC = 423,
        TOK_ACTION_EXPIRE_VAR = 424,
        TOK_ACTION_ID = 425,
        TOK_ACTION_INITCOL = 426,
        TOK_ACTION_LOG = 427,
        TOK_ACTION_LOG_DATA = 428,
        TOK_ACTION_MATURITY = 429,
        TOK_ACTION_MSG = 430,
        TOK_ACTION_MULTI_MATCH = 431,
        TOK_ACTION_NO_AUDIT_LOG = 432,
        TOK_ACTION_NO_LOG = 433,
        TOK_ACTION_PASS = 434,
        TOK_ACTION_PAUSE = 435,
        TOK_ACTION_PHASE = 436,
        TOK_ACTION_PREPEND = 437,
        TOK_ACTION_PROXY = 438,
        TOK_ACTION_REDIRECT = 439,
        TOK_ACTION_REV = 440,
        TOK_ACTION_SANITISE_ARG = 441,
        TOK_ACTION_SANITISE_MATCHED = 442,
        TOK_ACTION_SANITISE_MATCHED_BYTES = 443,
        TOK_ACTION_SANITISE_REQUEST_HEADER = 444,
        TOK_ACTION_SANITISE_RESPONSE_HEADER = 445,
        TOK_ACTION_SETENV = 446,
        TOK_ACTION_SETRSC = 447,
        TOK_ACTION_SETSID = 448,
        TOK_ACTION_SETUID = 449,
        TOK_ACTION_SEVERITY = 450,
        TOK_ACTION_SKIP = 451,
        TOK_ACTION_SKIP_AFTER = 452,
        TOK_ACTION_STATUS = 453,
        TOK_ACTION_TAG = 454,
        TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 455,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 456,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 457,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 458,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 459,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 460,
        TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 461,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 462,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 463,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 464,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 465,
        TOK_ACTION_TRANSFORMATION_LENGTH = 466,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 467,
        ...
        TOK_CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT = 526,
        TOK_CONFIG_DIR_REQ_BODY = 527,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 528,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 529,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 530,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 531,
        TOK_CONFIG_DIR_RES_BODY = 532,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 533,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 534,
        TOK_CONFIG_SEC_RULE_INHERITANCE = 535,
        TOK_CONFIG_SEC_RULE_PERF_TIME = 536,
        TOK_CONFIG_DIR_RULE_ENG = 537,
        TOK_CONFIG_DIR_SEC_ACTION = 538,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 539,
        TOK_CONFIG_DIR_SEC_MARKER = 540,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 541,
        TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 542,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 543,
        TOK_CONFIG_SEC_HTTP_BLKEY = 544,
        TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 545,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 546,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 547,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 548,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 549,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 550,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 551,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 552,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 553,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 554,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 555,
        TOK_CONFIG_UPLOAD_DIR = 556,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 557,
        TOK_CONFIG_UPLOAD_FILE_MODE = 558,
