...
#ifndef TEST_COMMON_CELEOWAF_TEST_H_
#define TEST_COMMON_CELEOWAF_TEST_H_
...
template <class T> class CeleoWAFTest :
...
#include "test/common/celeowaf_test.cc"


#endif  // TEST_COMMON_CELEOWAF_TEST_H_
